...
=======
    ...
    public function viewProduct($pid = null)
    {
        ...
        public function viewBrand($bid = null)
    {
        if (isset($bid)){
            $append = "brand_code ='$bid'";
        }
        else{
            $append = '';
        }
        return $this->get('brand',$append);

        }

        public function viewCategory($cid = null)
        {
            if (isset($cid)){
                $append = "product_category_code ='$cid'";
            }
            else{
                $append = '';
            }
            return $this->get('product_category',$append);
    
            }

            public function viewSubCategory($scid = null)
            {
                if (isset($scid)){
                    $append = "product_sub_category_code ='$scid'";
                }
                else{
                    $append = '';
                }
                return $this->get('product_sub_category',$append);
