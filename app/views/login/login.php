    ...
    <div class="registration-page">
      ...
      <div class="main-cards">
        ...
        <div class="reg-card">
              ...
              <form action="<?php echo BASEURL ?>/login/customerLogin" method="POST" id="form">
                ...
                <div>
                  <div class="input-container">
                    ...
                    <div class="input-field">
                      ...
                      <input type="text" id="field4" name="email_address" >
                    </div>

                         <div class="input-field">
                      <label for="field3">Password*</label>
                      <input type="text" id="field3" name="password" >
                    </div>
