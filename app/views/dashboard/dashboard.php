...
<div class="grid-container">
  ...
  <aside class="sidenav">
    ...
    <ul class="sidenav__list">
      ...
      <li class="sidenav__list-item"><a href="<?php echo BASEURL ?>/adminFunctions/fleetCenter">Add Vehicle</li>
      <li class="sidenav__list-item"><a href="<?php echo BASEURL ?>/adminFunctions/addDriver">Add driver</li>
