  ...
  <a class="link" href="<?php echo BASEURL ?>/home/signout"><i class='bx bxs-left-arrow-square'></i>&nbsp Signout</a>
            ...
            <main class="main">
                <div class="main-cards">
                    <div class="card">Purchase Requsition - PR001
                                    ...
                                    <div>
                                     <form>
                                        <div class="header-fields">
                                                ...
                                                <input class="disable-input-field"type="text" id="code" name="code" placeholder="PR004" required>
                                        ...
                                        <table id="myTable">
                                            ...
                                            <tr>
                                                ...
                                                <td><input class="input-field-description" type="text" name="po_no" placeholder="Type Here..." ></td>
