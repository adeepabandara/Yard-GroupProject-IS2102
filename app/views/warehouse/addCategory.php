...
>>>>>>> Stashed changes
        ...
        <div class="container">
          ...
          while ($row = $data['result']->fetch_assoc()) {
            ...
            $wc = $row['product_category_code'];

            echo "<tr>";
            echo "<td>" . $row["product_category_code"] . "</td>";
            echo "<td>" . $row["name"] . "</td>";
            echo "<td>" . $row["description"] . "</td>";
            echo "<td><a class='viewBtn' onclick='view(\"$wc\")'  href='#view' >View</a></td>";

            echo "<td><a class='delBtn' href=" . BASEURL . "/warehouse/deleteCategory/" . $row["product_category_code"] . "> Delete</a></td>";
            echo "</tr>";
          }
          echo "</table>";
...
>>>>>>> Stashed changes
            ...
            while ($row = $data['resultSubCat']->fetch_assoc()) {

              $wc = $row['product_sub_category_code'];

              echo "<tr>";
              echo "<td>" . $row["product_sub_category_code"] . "</td>";
              echo "<td>" . $row["name"] . "</td>";
              echo "<td>" . $row["description"] . "</td>";
              echo "<td><a class='viewBtn' onclick='viewSubCat(\"$wc\")'  href='#view1' >View</a></td>";

              echo "<td><a class='delBtn' href=" . BASEURL . "/warehouse/deleteSubCategory/" . $row["product_sub_category_code"] . "> Delete</a></td>";
              echo "</tr>";
            }
            echo "</table>";
      ...
      <form id="form" action="<?php echo BASEURL ?>/warehouse/createCategory1" method="POST">
        <div class="popup_card_fields">
          ...
          <div class="popup_card_input">
            ...
            <input type="text" name="product_category_code" placeholder="Type Here..." required>
          ...
          <div class="popup_card_input">
            ...
            <input type="text" name="name" class="form-input" placeholder="Type Here..." required>
      ...
      <form id="form1" action="<?php echo BASEURL ?>/warehouse/createSubCategory" method="POST">
        <div class="popup_card_fields">
          ...
          <div class="popup_card_input">
            ...
            <input type="text" name="product_sub_category_code" placeholder="Type Here...">
...
<div class="overlay" id="view">
  ...
  <div class="popup-main-cards">
    ...
    <div class="popup_card">
      ...
      <form action="<?php echo BASEURL ?>/warehouse/editCategory" method="POST">

        <div class="popup_card_fields">

          <div class="popup_card_input">
            <label>Category ID</label>
            <input id="product_category_code" name="product_category_code" type='text' ?>
          </div>
...
<div class="overlay" id="view1">
  ...
  <div class="popup-main-cards">
    ...
    <div class="popup_card">
      <h3>Category Details <a href="<?php echo BASEURL ?>/warehouse/subCategory"></a></h3>

      <form action="<?php echo BASEURL ?>/warehouse/editSubCategory" method="POST">
        ...
        <div class="popup_card_fields">
          ...
          <div class="popup_card_input">
            <label>Sub Category ID</label>
            <input id="product_sub_category_code" name="product_sub_category_code" type='text' ?>
          </div>
          ...
          <a class="closeBtn" href="<?php echo BASEURL ?>/warehouse/subCategory">Close</a>
...
<script>
  function view(product_category_code) {
    var url = '<?php echo "$path/warehouse/getCategory/" ?>' + product_category_code;
    console.log(url);
    fetch(url)
      .then((response) => response.json())
      .then((json) => {
        console.log(json);
        console.log(json[0].product_category_code);
        document.getElementById("product_category_code").value = json[0].product_category_code;
...
<script>
  function viewSubCat(product_sub_category_code) {
    var url = '<?php echo "$path/warehouse/getSubCategory/" ?>' + product_sub_category_code;
    console.log(url);
    fetch(url)
      .then((response) => response.json())
      .then((json) => {
        console.log(json);
        console.log(json[0].product_sub_category_code);
        document.getElementById("category").value = json[0].category;
        document.getElementById("product_sub_category_code").value = json[0].product_sub_category_code;
        document.getElementById("name").value = json[0].name;
        document.getElementById("description").value = json[0].description;
      })
