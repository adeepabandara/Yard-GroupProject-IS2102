...
$rows = mysqli_query($conn, "SELECT * FROM fleetcenter");
...
<div class="grid-container">
  ...
  <header class="header">Admin&nbsp>&nbsp Fleet Center<div>&nbsp&nbsp&nbsp<img src="<?php echo BASEURL ?>/images/img_avatar.png"class="avatar"></a></div></header>
  ...
  <main class="main">
    ...
    <div class="main-cards">
      ...
      <div class="card">Add Fleet Center
     

 
        <div class="container">
          <form action="<?php echo BASEURL ?>/adminFunctions/createFleetcenter" method="POST" id="form">
            <div class="form first">
              <div>
                ...
                <div class="fields">
                  <div class="input-field">
                    ...
                    <input name="fleetcenter_code" type="text" placeholder="Type Here" required>
              ...
              <button class="subBtn" onclick="createWarehouse()" type="submit" >
                <span class="btnText"  >Create Fleet Center</span>
              </button>
            </div>
          </form>
      ...
      <div class="card">Fleet Center List
        ...
        <div class="container">
          ...
          <table>
            ...
            <tr>
              ...
              <td><?php echo $row["fleetcenter_code"]; ?></td>
              <td><?php echo $row["name"]; ?></td>
              <td><?php echo $row["address"]; ?></td>
              <td><a class="viewBtn" href="#view"  >View</a></td> 
              <td><a class="delBtn" onclick="deleteFleetcenter()" href="<?php echo BASEURL ?>/adminFunctions/deleteFleetcenter/fleetcenter_code"> Delete</a></td>
...
<h3>Fleet Center Details <a href="<?php echo BASEURL ?>/fleetcenter/createWarehouse">X</a></h3>
          ...
          <form action="<?php echo BASEURL ?>/warehouse/createWarehouse" method="POST">
            ...
            <div class="popup_card_fields">
                  ...
                  <div class="popup_card_input">
                    <label>Center Code</label>
                    <input name="fleetcenter_code" value = <?php echo $row["fleetcenter_code"]; ?> >
                  </div>
                  <div class="popup_card_input">
                    <label>Center Name</label>
                  ...
                  <div class="popup_card_input">
                    ...
                    <input name="email_address" value =<?php echo $row["email_address"];?>>
        ...
        <a class="closeBtn" href="<?php echo BASEURL ?>/adminFunctions/fleetcenter">Close</a>
